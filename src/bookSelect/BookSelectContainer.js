...
export class BookSelectContainer extends React.Component {
    constructor(props) {
        super(props);
        this.state = { pageNumber: 1, bookList: '', numberOfBooks: 0 };
    ...
    async getAllBooks() {
        console.log('pageNumber in getAllBooks: ' + this.state.pageNumber);
    ...
    changePage(e) {
        ...
        console.log('pageNumber in changePage: ' + this.state.pageNumber);
        //this.getAllBooksTemp();
    }
